...
import com.voltagelab.namazshikkhaapps.Activity.AlQuran.ayahword.model.Corpus;
...
public class CorpusDataSource {
  ...
  public Corpus getCorpusById(long id) {
    ...
    while (!cursor.isAfterLast()) {
      corpus.setRoot(cursor.getString(cursor.getColumnIndexOrThrow(CORPUS_ROOT)));
      corpus.setArabic1(cursor.getString(cursor.getColumnIndexOrThrow(CORPUS_ARABIC1)));
      corpus.setArabic2(cursor.getString(cursor.getColumnIndexOrThrow(CORPUS_ARABIC2)));
      corpus.setArabic3(cursor.getString(cursor.getColumnIndexOrThrow(CORPUS_ARABIC3)));
      corpus.setArabic4(cursor.getString(cursor.getColumnIndexOrThrow(CORPUS_ARABIC4)));
      corpus.setArabic5(cursor.getString(cursor.getColumnIndexOrThrow(CORPUS_ARABIC5)));
      corpus.setWord_type_id1(cursor.getLong(cursor.getColumnIndexOrThrow(CORPUS_WORD_TYPE_ID1)));
      corpus.setWord_type_id2(cursor.getLong(cursor.getColumnIndexOrThrow(CORPUS_WORD_TYPE_ID2)));
      corpus.setWord_type_id3(cursor.getLong(cursor.getColumnIndexOrThrow(CORPUS_WORD_TYPE_ID3)));
      corpus.setWord_type_id4(cursor.getLong(cursor.getColumnIndexOrThrow(CORPUS_WORD_TYPE_ID4)));
      corpus.setWord_type_id5(cursor.getLong(cursor.getColumnIndexOrThrow(CORPUS_WORD_TYPE_ID5)));
      cursor.moveToNext();
    }
