package com.voltagelab.namazshikkhaapps.Activity.downloadhelper.core.task;
...
public class GetFileInfoTask implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            downloadResponse.handleException(downloadInfo, new DownloadException(DownloadException.EXCEPTION_OTHER, e));
        }
    }
