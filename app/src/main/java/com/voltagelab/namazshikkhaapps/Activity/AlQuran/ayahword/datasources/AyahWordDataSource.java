package com.voltagelab.namazshikkhaapps.Activity.AlQuran.ayahword.datasources;
...
import com.voltagelab.namazshikkhaapps.Activity.AlQuran.ayahword.model.AyahWord;
import com.voltagelab.namazshikkhaapps.Activity.AlQuran.ayahword.model.Word;
  ...
  public ArrayList<AyahWord> getEnglishAyahWordsBySurah(long surah_id, long ayah_number) {
    ...
    for (long i = 1; i <= ayah_number; i++) {
      ...
      while (i == tempVerseWord && !cursor.isAfterLast()) {
        ...
        tempVerseWord = cursor.getLong(cursor.getColumnIndexOrThrow(AYAHWORD_VERSE_ID));
        if (tempVerseWord != i) {
          continue;
        }
        Word word = new Word();
        ...
        word.setVerseId(cursor.getLong(cursor.getColumnIndexOrThrow(AYAHWORD_VERSE_ID)));
        word.setWordsId(cursor.getLong(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_ID)));
        word.setWordsAr(cursor.getString(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_AR)));
        word.setTranslate(cursor.getString(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_TRANSLATE_EN)));
      ...
      while (i == tempVerseQuran && !quranCursor.isAfterLast()) {
        tempVerseQuran = quranCursor.getLong(quranCursor.getColumnIndexOrThrow(QURAN_VERSE_ID));
        if (tempVerseQuran != i) {
          continue;
        }
        ayahWord.setQuranVerseId(quranCursor.getLong(quranCursor.getColumnIndexOrThrow(QURAN_VERSE_ID)));
        ayahWord.setQuranArabic(quranCursor.getString(quranCursor.getColumnIndexOrThrow(QURAN_ARABIC)));
        ayahWord.setQuranTranslate(
            quranCursor.getString(quranCursor.getColumnIndexOrThrow(QURAN_ENGLSIH)));
  ...
  public ArrayList<AyahWord> getBanglaAyahWordsBySurah(long surah_id, long ayah_number) {
    ...
    for (long i = 1; i <= ayah_number; i++) {
      ...
      while (i == tempVerseWord && !cursor.isAfterLast()) {
        ...
        word.setWordsId(cursor.getLong(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_ID)));
        word.setWordsAr(cursor.getString(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_AR)));
        word.setTranslate(cursor.getString(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_TRANSLATE_BN)));
        wordArrayList.add(word);
        cursor.moveToNext();
      }
      while (i == tempVerseQuran && !quranCursor.isAfterLast()) {
        ...
        ayahWord.setQuranVerseId(quranCursor.getLong(quranCursor.getColumnIndexOrThrow(QURAN_VERSE_ID)));
        ayahWord.setQuranArabic(quranCursor.getString(quranCursor.getColumnIndexOrThrow(QURAN_ARABIC)));
        ayahWord.setQuranTranslate(quranCursor.getString(quranCursor.getColumnIndexOrThrow(QURAN_BANGLA)));
        quranCursor.moveToNext();
      }
      ayahWord.setWord(wordArrayList);
      ayahWordArrayList.add(ayahWord);
  ...
  public ArrayList<AyahWord> getIndonesianAyahWordsBySurah(long surah_id, long ayah_number) {
    ...
    for (long i = 1; i <= ayah_number; i++) {
      ...
      while (i == tempVerseWord && !cursor.isAfterLast()) {
        ...
        word.setWordsId(cursor.getLong(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_ID)));
        word.setWordsAr(cursor.getString(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_AR)));
        word.setTranslate(cursor.getString(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_TRANSLATE_INDO)));
      ...
      while (i == tempVerseQuran && !quranCursor.isAfterLast()) {
        ...
        ayahWord.setQuranVerseId(quranCursor.getLong(quranCursor.getColumnIndexOrThrow(QURAN_VERSE_ID)));
        ayahWord.setQuranArabic(quranCursor.getString(quranCursor.getColumnIndexOrThrow(QURAN_ARABIC)));
        ayahWord.setQuranTranslate(quranCursor.getString(quranCursor.getColumnIndexOrThrow(QURAN_INDO)));
  ...
  public ArrayList<Word> getEnglishWordsBySurah(long surah_id, long ayah_number) {
    ...
    while (!cursor.isAfterLast()) {
      ...
      Log.d(
          ...
          "currentAyah: "
              + " "
              + cursor.getString(cursor.getColumnIndexOrThrow(AYAHWORD_WORDS_TRANSLATE_EN)));
      wordArrayList.add(word);
