package com.voltagelab.namazshikkhaapps.Activity.AlQuran.ayahword.adapter;
...
import com.voltagelab.namazshikkhaapps.Activity.AlQuran.ayahword.FlowLayout;
import com.voltagelab.namazshikkhaapps.Activity.AlQuran.ayahword.datasources.CorpusDataSource;
...
public class AyahWordAdapter extends RecyclerView.Adapter<AyahWordAdapter.AyahViewHolder> {
  ...
  public AyahWordAdapter(ArrayList<AyahWord> ayahWordArrayList, Context context, long surah_id) {
    ...
    corpusTypeface = Typeface.createFromAsset(context.getResources().getAssets(), "fonts/noorehuda.ttf");
  }
